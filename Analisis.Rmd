...
## 4.4 Comprovació Hipòtesis
 A continuació farem el test de Wilcoxon per determinar si hi ha diferències en l'efectivitat de llençament segons la distància. La nostra hipòtesis nul·la és la no diferència entre els tirs llunyants i propers, i la hipòtesis alternativa és que a menor distància més facil és acertar i major precissió. Demanem el resultat amb un nivell de confiança del 95%.
```{r}
